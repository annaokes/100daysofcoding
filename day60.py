...
while run:
    ...
    if live_ball == False:
        if game_over == 0:
            draw_text('Click to start', font,text_col, 200, screen_height//2)
        elif game_over == 1:
            draw_text('YOU WON!', font, text_col, 200, screen_height // 2)
        elif game_over == -1:
            draw_text('YOU LOST!', font, text_col, 200, screen_height // 2)
